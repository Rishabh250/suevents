...
userLogin(email, pass, deviceID) async {
  try {
    var response = await https.post(
        Uri.parse(
            "https://suevents2022.herokuapp.com/loginUser"),
        body: jsonEncode({
...
createStudent(
  ...
  try {
    var response = await https.post(
        Uri.parse(
            "https://suevents2022.herokuapp.com/createUser"),
        body: jsonEncode({
          "email": email.toString(),
          "password": pass.toString(),
          "name": name.toString(),
...
resetPassword(email, pass) async {
  try {
    var response = await https.post(
        Uri.parse(
            "https://suevents2022.herokuapp.com/forgetPassword"),
...
sendOTP(email) async {
  try {
    var response = await https.post(
        Uri.parse(
            "https://suevents2022.herokuapp.com/sendOTP"),
        headers: {"Content-Type": "application/json"},
...
verifyOTP(email, otp) async {
  try {
    var response = await https.post(
        Uri.parse(
            "https://suevents2022.herokuapp.com/verifyOTP"),
        headers: {"Content-Type": "application/json"},
...
getUserData(token) async {
  try {
    var response = await https.get(
        Uri.parse(
            "https://suevents2022.herokuapp.com/userInfo"),
        headers: {
...
uploadProfileImage(token, image) async {
  ...
  try {
    var response = await https.post(
        Uri.parse(
            "https://suevents2022.herokuapp.com/uploadImage"),
        headers: headers,
...
checkDevice(deviceID) async {
  ...
  try {
    var response = await https.post(
        Uri.parse(
            "https://suevents2022.herokuapp.com/checkDevice"),
        headers: headers,
...
updateDetails(id, course, year, semester) async {
  try {
    var response = await https.post(
        Uri.parse(
            "https://suevents2022.herokuapp.com/updateDetails"),
        headers: {"Content-Type": "application/json"},
        body: jsonEncode({
          "id": "$id",
          "course": "$course",
