...
class ViewAllGeneral extends StatefulWidget {
  const ViewAllGeneral({Key? key}) : super(key: key);

  @override
  State<ViewAllGeneral> createState() => _ViewAllGeneralState();
}

class _ViewAllGeneralState extends State<ViewAllGeneral> {
